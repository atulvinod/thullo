export const getBoardColumns = (state) => state.board.columns;
export const getHoverColumn = (state) => state.board.currentHoverColumn;
export const getAllBoards = (state) => state.board.allBoards;
